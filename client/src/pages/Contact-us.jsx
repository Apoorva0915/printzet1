    ...
    return (
      <div className="bg-gray-50 py-16 px-6">
        ...
        <div className="max-w-4xl mx-auto mt-12 text-center">
          ...
          <p className="text-gray-600 mt-4 text-lg">📞 Phone: <a href="tel:+917325966706" className="text-blue-600">+91 73259 66706</a></p>
          <p className="text-gray-600 text-lg">📧 Email: <a href="mailto:info@zenlynxtechnologies.com" className="text-blue-600">info@zenlynxtechnologies.com</a></p>
        </div>
      </div>
    );
  };
